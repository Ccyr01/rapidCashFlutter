...
import 'schema/punchcard_record.dart';
...
export 'schema/punchcard_record.dart';
...
/// Functions to query PunchcardRecords (as a Stream and as a Future).
Future<int> queryPunchcardRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PunchcardRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PunchcardRecord>> queryPunchcardRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PunchcardRecord.collection,
      PunchcardRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PunchcardRecord>> queryPunchcardRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
